...
def clone_and_analyze_repo(repo_url):
    ...
    try:
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            clone_result = clone_repo(repo_url, temp_dir)
            
            if 'error' in clone_result:
                return clone_result
            
            # Analyze the repository structure
            structure = analyze_repo_structure(temp_dir)
            
            # Analyze code patterns
            patterns = analyze_code_patterns(temp_dir)
            
            # Generate insights
            insights = generate_insights(structure, patterns, repo_url)
...
def analyze_code_patterns(repo_dir):
    """
    ...
    try:
        ...
        patterns = analyze_patterns_with_openai(file_contents)
...
def analyze_patterns_with_openai(file_contents):
    """
...
def generate_insights(structure, patterns, repo_url):
    """
